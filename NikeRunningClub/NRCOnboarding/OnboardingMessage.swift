...
extension OnboardingMessage {
    static let messages: [OnboardingMessage] = [
        OnboardingMessage(imageName: "img_nike_nrc", title: "Nevertheless", description: "New to the club? Join now and get started.\n Alread running with nike? Log in or join now and we'll show every run you've done with us."),
        ...
        OnboardingMessage(imageName: "3", title: "MUSIC MOVES YOU", description: "You're first race, last mile, or push out the door whatever your pace, distance or need, we've got the playlist to match"),
        OnboardingMessage(imageName: "2", title: "MUSIC MOVES YOU", description: "You're first race, last mile, or push out the door whatever your pace, distance or need, we've got the playlist to match")
    ]
